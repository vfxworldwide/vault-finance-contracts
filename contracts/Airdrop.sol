...
contract Airdrop is Ownable {
    ...
    function claim() external {
        require (invests[msg.sender] > 0, "!available");
        require (!claimed[msg.sender], "!already claimed");
        require (invests[msg.sender] <= token.balanceOf(address(this)), "Insufficient balance");
        
        token.safeTransfer(msg.sender, invests[msg.sender]);
